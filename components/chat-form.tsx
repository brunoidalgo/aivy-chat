...
export function ChatForm({ className, ...props }: React.ComponentProps<"form">) {
    ...
    const header = (
        <header className="m-auto flex max-w-96 flex-col gap-5 text-center">
            <h1 className="text-2xl font-semibold leading-none tracking-tight">Aivy Chat chatbot com IA</h1>
    ...
    return (
        <TooltipProvider>
            <main
                ...
                {...props}
            >
                <div className="flex-1 content-center overflow-y-auto px-6 h-[calc(100vh-120px)]">
